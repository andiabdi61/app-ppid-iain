...
// Fungsi untuk membuka Modal Pejabat (Pengganti Bootstrap Modal)

// Fungsi untuk mengontrol tombol "Kembali ke atas" dan animasi wiggle
document.addEventListener("DOMContentLoaded", function () {
    const scrollToTopButton = document.getElementById("scroll-to-top");
    const wiggleButton = document.querySelector(
        ".floating-list .floating-item:first-child button",
    );
    let scrollTimeout;
    ...
    window.addEventListener("scroll", () => {
        ...
        if (
            wiggleButton &&
            !wiggleButton.classList.contains("animate-wiggle")
        ) {
