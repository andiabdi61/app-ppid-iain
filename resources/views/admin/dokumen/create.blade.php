<x-app-layout>
                    ...
                    <form action="{{ route('admin.dokumen.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="space-y-6 mb-8">
                            ...
                            <div>
                                ...
                                <input type="text" name="judul" id="judul" value="{{ old('judul') }}" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                            </div>
                            ...
                            <div>
                                ...
                                <textarea name="deskripsi" id="deskripsi" rows="3" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('deskripsi') }}</textarea>
                            </div>
                        </div>
                        ...
                        <div id="doc-translation-fields" class="hidden space-y-6 mb-8 p-6 bg-gray-50 border border-dashed border-gray-300 rounded-xl">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" name="judul_en" id="judul_en" value="{{ old('judul_en') }}" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                                <div>
                                    <label for="judul_ar" class="block text-sm font-medium text-gray-700 mb-1 text-right">🇸🇦 Judul (العربية)</label>
                                    <input type="text" name="judul_ar" id="judul_ar" value="{{ old('judul_ar') }}" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-right" dir="rtl">
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <textarea name="deskripsi_en" id="deskripsi_en" rows="3" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('deskripsi_en') }}</textarea>
                                </div>
                                <div>
                                    <label for="deskripsi_ar" class="block text-sm font-medium text-gray-700 mb-1 text-right">🇸🇦 Deskripsi (العربية)</label>
                                    <textarea name="deskripsi_ar" id="deskripsi_ar" rows="3" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-right" dir="rtl">{{ old('deskripsi_ar') }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                <label for="file_dokumen" class="block text-sm font-medium text-gray-700 mb-1">Upload File Dokumen</label>
                                <input type="file" name="file_dokumen" id="file_dokumen" 
                                    ...
                                    required>
                                <p class="mt-1 text-xs text-gray-500">Format: PDF, DOCX, XLSX, PPTX (Maks 5MB)</p>
                                @error('file_dokumen')
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="date" name="tanggal_publikasi" id="tanggal_publikasi" value="{{ old('tanggal_publikasi') }}" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
    ...
    <!-- SCRIPT TRANSLATE DOKUMEN (LEBIH SEDERHANA KARNA TANPA TINYMCE) -->
    <script>
        ...
        async function translateDocFields(target) {
            ...
            // Buka kolom terjemahan jika masih tertutup
            ...
            // Hitung total langkah untuk progress bar
