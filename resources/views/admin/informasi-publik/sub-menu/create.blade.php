                    ...
                    <form action="{{ route('admin.informasi-publik.sub-menu.store', $informasi_publik_item) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div class="space-y-5">
                                ...
                                <div class="p-4 bg-gray-50 rounded-lg border border-gray-200 mt-2" x-data="{ jenisTautan: '{{ old('jenis_tautan', 'file') }}' }">
                            ...
                            <div class="space-y-5">
                                ...
                                <div>
                                    <label for="tanggal_publikasi" class="block text-sm font-bold text-gray-700 mb-1">
                                        Tanggal Publikasi <span class="text-gray-400 font-normal text-xs">(Opsional)</span>
                                    </label>
                                ...
                                <div>
                                    <label for="sort_order" class="block text-sm font-bold text-gray-700 mb-1">
                                        Urutan Tampil <span class="text-gray-400 font-normal text-xs">(Opsional)</span>
                                    </label>
                                ...
                                <div>
                                    <label for="thumbnail" class="block text-sm font-bold text-gray-700 mb-1">
                                        Upload Thumbnail <span class="text-gray-400 font-normal text-xs">(Opsional)</span>
                                    </label>
