    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div class="flex justify-center">
            <div class="w-full max-w-lg text-center">
                ...
                {{-- Icon Error --}}
                <div class="inline-flex items-center justify-center w-24 h-24 rounded-full bg-red-50 border border-red-100 mb-6">
                    <i class="fas fa-ban text-red-300 text-4xl"></i>
                </div>

                {{-- Kode Error --}}
                <h1 class="text-7xl sm:text-8xl font-extrabold text-red-200 tracking-tighter">403</h1>
                
                {{-- Judul --}}
                <h2 class="text-2xl sm:text-3xl font-bold text-gray-900 mt-4 mb-3">Akses Ditolak</h2>
