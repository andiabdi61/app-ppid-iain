            ...
            <div class="w-full max-w-2xl">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    <div class="p-8 md:p-12 text-center">
                        ...
                        {{-- Icon Sukses --}}
                        <div class="mb-6 inline-flex items-center justify-center w-20 h-20 rounded-full bg-blue-100">
                            <i class="bi bi-envelope-check-fill text-blue-600 text-4xl"></i>
                        </div>

                        <h1 class="text-2xl md:text-3xl font-bold text-gray-900 mb-3">Pesan Berhasil Terkirim!</h1>
